...
export const INVALID_INDEXES = [-1, 1.1, Math.pow(2, 32)]

export const INVALID_SECRET_KEYS = [
  '',
...
export const INVALID_PUBLIC_KEYS = [
  '',
...
export const INVALID_THRESHOLDS = [-1n, 0xffffffffffffffffffn]

export const INVALID_WORKS = [
  '',
  '000000000995bc3',
  '000000000995bc333',
  'z000000000995bc3',
...
export const INVALID_BLOCK_COMBINATIONS_COMMON = {
