...
pub fn transform_u64_to_array_of_u8_le(x: u64, dst: &mut [u8]) {
    dst[0] = ((x >> 56) & 0xff) as u8;
    dst[1] = ((x >> 48) & 0xff) as u8;
    dst[2] = ((x >> 40) & 0xff) as u8;
    dst[3] = ((x >> 32) & 0xff) as u8;
    dst[4] = ((x >> 24) & 0xff) as u8;
    dst[5] = ((x >> 16) & 0xff) as u8;
    dst[6] = ((x >> 8) & 0xff) as u8;
    dst[7] = (x & 0xff) as u8;
}
