...
/* tslint:disable function-name variable-name no-parameter-reassignment */
...
function cryptoVerify32(x: Uint8Array, xi: number, y: Uint8Array, yi: number) {
...
function cryptoSign(sm: Uint8Array, m: Uint8Array, n: number, sk: Uint8Array) {
...
function cryptoSignOpen(m: Uint8Array, sm: Uint8Array, n: number, pk: Uint8Array) {
  let i;
  let mlen;
...
function naclSign(msg: Uint8Array, secretKey: Uint8Array) {
...
/** @hidden */
export function verifyDetached(msg: Uint8Array, sig: Uint8Array, publicKey: Uint8Array) {
